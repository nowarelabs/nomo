...
export default defineConfig({
  description: "Noware framework documentation",
  ...
  themeConfig: {
    siteTitle: "",
    logo: { light: "/assets/noware.png", dark: "/assets/noware-dark.png" },
    ...
    // Social links
    socialLinks: [{ icon: "github", link: "https://github.com/nowarelabs/noware" }],
    ...
    editLink: {
      text: "Edit this page",
      pattern: "https://github.com/nowarelabs/noware/edit/main/packages/docs/docs/:path",
    },
    ...
    footer: {
      ...
      copyright: "Copyright © 2024-present Noware Framework",
    },
  },
  head: [
    ...
    [
      "link",
      {
        href: "https://fonts.googleapis.com/css2?family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&family=JetBrains+Mono:wght@400;500;600&display=swap",
        rel: "stylesheet",
      },
    ],
  ],
