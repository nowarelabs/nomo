# Noware Framework - AI Agent Guide

This document provides AI agents with the knowledge needed to create, navigate, and work with projects built using the Noware framework on Cloudflare Workers.

## Project Structure

A typical Noware project follows this structure:
...
```typescript
import { BaseModel } from "noware/models";
...
```typescript
import { BaseValidator } from "noware/validators";
import { z } from "zod";
...
```typescript
import { BaseNormalizer } from "noware/normalizers";
